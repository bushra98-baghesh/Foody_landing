...
function Footer() {
  return (
    <footer className=" bg-gradient-to-r from-[#c3f49d] via-[#d7f0c4] to-[#c3f49d]">
      <div className="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <div className="grid grid-cols-1 py-6  gap-4  lg:col-span-2 tracking-wider sm:grid-cols-3">
